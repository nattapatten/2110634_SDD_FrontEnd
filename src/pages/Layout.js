...
const Layout = () => {
  ...
  // Calculate styles based on whether the sidebar is shown
  const mainContentStyle = {
    marginLeft: show ? '400px' : '0', // Adjust the margin to shift content
  ...
  return (
    <>
        ...
        <Offcanvas.Body>
          <nav>
            <ul>
              ...
              <li>
                <Link to="/Example" onClick={handleClose}>
                  Style Guides
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/LoginOTP" onClick={handleClose}>
                  LoginOTP
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/RegisterOTP" onClick={handleClose}>
                  RegisterOTP
                </Link>
              </li>
              <li>
                <Link to="/SelectPath" onClick={handleClose}>
                  SelectPath
                </Link>
              </li>
              <li>
                <Link to="/DashboardAdvisor" onClick={handleClose}>
                  DashboardAdvisor
                </Link>
              </li>
            </ul>
      ...
      {/* Outlet for rendering the matched route components, with style adjusted based on sidebar state */}
